...
- name: Microsoft Graph API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/instances/master/_listings/microsoft-graph/users-id-|-userprincipalname-events-id-instances-get.md
x-common:
- type: x-change-loge
