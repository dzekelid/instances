...
- name: Microsoft Graph API List Instances
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/instances/master/_listings/microsoft-graph/users-id-|-userprincipalname-events-id-instances-get.md
x-common:
- type: x-change-loge
