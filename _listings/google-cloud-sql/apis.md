...
- name: Google Cloud SQL API Add Projects Project Instances Instance Truncatelog
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/instances/master/_listings/google-cloud-sql/projects-project-instances-instance-truncatelog-post.md
x-common:
- type: x-change-log
